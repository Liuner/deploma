    ...
    <div id="content">
        ...
        <form id="one" class="form-signin" type="post">
            ...
            <div class="pretty p-switch p-fill">
                <input type="radio" name="adminSex" id="generalNameMan" value="man"/>
                <div class="state p-success">
                    <label for="man">MAN</label>
                </div>
            </div>
            <div class="pretty p-switch p-fill">
                <input type="radio" name="adminSex" id="generalFemale" value="female"/>
                <div class="state p-success">
        ...
        <%--------------------------------------------Admin-------------------------------------------%>
        <form id="three" class="form-signin" type="post" href="http://localhost:8088/demo/createAdminInfo" style="display:none">
