...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    @Override
    public UserInfoRspBo selectUserInfoById(Long id) {
        LOG.info("进入selectUserInfoById服务");
    ...
    @Override
    public List<UserInfoRspBo> queryInfo() {
        LOG.info("进入queryInfo服务");
        List<UserInfoRspBo> userInfoRspBoList = new ArrayList<UserInfoRspBo>();
        List<UserInfoPo> userInfoPoList = userInfoMapper.selectAllUserInfo();
